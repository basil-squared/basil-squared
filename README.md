...
- [sinister-minds-discs](https://github.com/basil-squared/sinister-minds-discs) ([v1.1.6](https://github.com/basil-squared/sinister-minds-discs/releases/tag/v1.1.6), today) - a mod for Minecraft Fabric 1.21.11 that adds the tracks of Sinister Minds by Churgney Gurgney to Minecraft, because I like the songs.
