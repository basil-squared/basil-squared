...
- [create_gauntlets](https://github.com/basil-squared/create_gauntlets) - Adds a new weapon type, the gauntlets!  (6 days ago)
...
- [tux](https://github.com/allthingslinux/tux) ([v0.1.0](https://github.com/allthingslinux/tux/releases/tag/v0.1.0), 1 day ago) - The all-in-one open source Discord bot brought to you by @allthingslinux
